        ...
        <div className="container" style={{ padding: 'var(--space-8) var(--space-4)', flex: 1 }}>
            <div style={{ maxWidth: '600px', margin: '0 auto' }}>
                ...
                <div className="glass-panel" style={{ padding: 'var(--space-8)', marginTop: 'var(--space-6)', border: '1px solid rgba(248, 113, 113, 0.2)' }}>
                    ...
                    <button className="btn-secondary" style={{ color: '#f87171', borderColor: 'rgba(248, 113, 113, 0.3)', width: '100%' }} onClick={() => alert('Account deletion is restricted for demo security.')}>
                        Delete Account
                    </button>
                </div>
            </div>
